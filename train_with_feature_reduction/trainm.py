...
import PIL
from Networksm import Netm
from pathlib import Path
from PIL import Image
from torchvision.models import vgg19_bn
import glob
from torch.autograd import Variable
import data_fea_loader
...
fh = logging.handlers.RotatingFileHandler('./logfile_train_with_reduction_feature_miyani.log')
...
#     print(root)
    ...
    dset = data_fea_loader.covid_ct(root, csv_file)
